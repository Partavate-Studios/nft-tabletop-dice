    ...
    <g>
      ...
      <g transform="translate(256 256) scale(2)">
        <g stroke-width="0.1" stroke="#ffffff">
          <g name="d6_body">
            <g fill="#1a1a1a" fill-opacity="1" stroke-width="0.5" stroke="#1a1a1a" filter="url(#blur)">
      ...
      <g>
        <g>
          ...
          <g name="dots_fill" fill="#0000ff" stroke="#0000ff" stroke-opacity="0.25">
            <g transform="translate(256 256) scale(2)">
              <g>

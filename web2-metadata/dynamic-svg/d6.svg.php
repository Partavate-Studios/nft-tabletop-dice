<svg xmlns="http://www.w3.org/2000/svg" xml:space="preserve" width="512px" height="512px" version="1.1" shape-rendering="geometricPrecision" text-rendering="geometricPrecision" image-rendering="optimizeQuality" fill-rule="evenodd" clip-rule="evenodd" viewBox="0 0 512 512"
  ...
  <defs>
    ...
    <filter style="color-interpolation-filters: srgb;" id="blur" x="-0.0094531421" y="-0.0082647294" width="1.0189063" height="1.0165295">
      <feGaussianBlur stdDeviation="0.53908528"></feGaussianBlur>
    </filter>
          ...
          <g name="dots_fill" fill="#<?php echo $foregroundColor ?>" stroke="#<?php echo $foregroundColor ?>" stroke-opacity="0.25">
            <g transform="translate(256 256) scale(2)">
              <g>
                ...
                <ellipse cx="9" cy="-34.5" rx="8" ry="0.4"></ellipse>
                <ellipse cx="-17" cy="-10" rx="9" ry="8"></ellipse>
                <ellipse cx="17" cy="-10" rx="9" ry="8"></ellipse>
                <ellipse cx="-16" cy="11" rx="8" ry="7"></ellipse>
                <ellipse cx="16" cy="11" rx="8" ry="7"></ellipse>
                <ellipse cx="-15" cy="30" rx="7.5" ry="6.5"></ellipse>
                <ellipse cx="15" cy="30" rx="7.5" ry="6.5"></ellipse>
              </g>
            </g>
          </g>
          <g name="dots_outline" fill="url('#dotshade')" stroke="#000000" stroke-opacity="0.3">
            <g transform="translate(256 256) scale(2)">
              <g>
                <ellipse cx="-12" cy="-31.5" rx="10" ry="0.5"></ellipse>
                <ellipse cx="9" cy="-34.5" rx="8" ry="0.4"></ellipse>

<script>
import backgroundPathSvg from './background-path.svg.vue'
import BackgroundPath from './background-path.svg.vue'

export default {
  components: { backgroundPathSvg },
  props: {
    backgroundColor: {
      type: String,
      default: '#0000ff'

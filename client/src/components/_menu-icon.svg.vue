...
<template>
  <g fill="#ffffff" stroke="#ffffff" @mouseover="hover = true" @mouseleave="hover = false"  class="can-click" transform="scale(0.8)">
    <circle r="60" fill-opacity="0" stroke="2" stroke-opacity="0.2" />
    <g transform="scale(0.1) translate(-448 -512)" :fill-opacity="fillOpacity">
